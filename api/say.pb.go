...
func (*Text) Descriptor() ([]byte, []int) {
	return fileDescriptor_say_a884db78c16b4796, []int{0}
}
...
func (*Speech) Descriptor() ([]byte, []int) {
	return fileDescriptor_say_a884db78c16b4796, []int{1}
}
...
func init() { proto.RegisterFile("say.proto", fileDescriptor_say_a884db78c16b4796) }

var fileDescriptor_say_a884db78c16b4796 = []byte{
